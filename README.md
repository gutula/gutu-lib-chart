...
| Primary focus | charts, visual analytics, dashboard primitives |
...
- This repo currently publishes `@platform/chart` as the legacy compatibility package id while the migration to `@gutu/chart` is completed.
